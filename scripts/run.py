...
class CommandWrapper:
    ...
    def _timeit(self, args):
        return 'timeit -n {} -r {} -s {}'.format(args.times_to_run, args.repeats, args.statement)
...
command = CommandWrapper(timeItArgs) #TODO: make the number of times to run a configurable parameter
command.run()