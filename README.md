...
There are two summations here, one of the area of geometric shapes, rectangle, circle and triangle, and one of an arbitrary corner weighted area.
...
To run unit tests: `python3 -m unittest discover -s tests`
